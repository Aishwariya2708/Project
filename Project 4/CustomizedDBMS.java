...
class CustomizedDBMS
{
    public static void main(String Arg[])
    {
        ...
        mobj.InsertIntoTable("Gaurav Sharma","SB Road 4 Nashik ",21000);
        mobj.InsertIntoTable("Chinmayee Patil","LB road 9 Mumbai",20000);
        mobj.InsertIntoTable("Akash Sudame","FC road 3 Satara",25000);
        ...
        while(true)
        {
            ...
            switch(iOption)
            {
                ...
                case 13 : 
                    System.out.println("This project developed by - Aishwariya Bokefode");
